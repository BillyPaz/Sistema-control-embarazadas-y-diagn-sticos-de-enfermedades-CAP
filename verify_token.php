...
<header class="header">
  <div class="header-content container">
    <div class="header-txt"><h1>Verificar código</h1></div>
  </div>
</header>

<main class="wrap">
  <div class="cardx">
    <p class="text-muted">Hemos enviado un código de 6 dígitos a <b><?= htmlspecialchars($correo) ?></b>.</p>

    <?php if(isset($_GET['e']) && $_GET['e']==='1'): ?>
      <div class="alert alert-danger py-2">Código inválido o vencido.</div>
    <?php endif; ?>

    <form action="php/verify_token_procesar.php" method="post" autocomplete="off">
      <div class="mb-3">
        ...
        <div class="form-text">Vigencia: 15 minutos</div>
      </div>
      <div class="d-grid">
    ...
    <div class="mt-3 d-flex gap-3">
      <a class="lnk" href="recuperar.php">&larr; Cambiar correo</a>
    </div>
  </div>
</main>
</body>
